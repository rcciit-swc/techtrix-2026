              ...
              >
                <div className="relative z-10 flex flex-col gap-8 items-center w-full">
                        ...
                        <SelectContent className="bg-black/95 backdrop-blur-md border border-white/20 rounded-xl">
                          {['Female', 'Male', 'Other'].map((v) => (
                            <SelectItem
                              key={v.toLowerCase()}
                              value={v.toLowerCase()}
                              className="text-white focus:text-yellow-400 hover:bg-white/10 focus:bg-white/10 font-medium text-[16px] font-[Maname]"
                            >
                              {v}
                            </SelectItem>
                          ))}
                  ...
                  <Button
                    ...
                    className="w-full max-w-[500px] h-[48px] bg-yellow-400 hover:bg-yellow-300 text-black font-bold text-[18px] rounded-full shadow-[0_0_15px_rgba(250,204,21,0.3)] transition-all duration-300 border-0 uppercase tracking-wider font-['Metal_Mania']"
                  >
