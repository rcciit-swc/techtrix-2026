      ...
      <DialogContent className="sm:max-w-[682px] md:max-w-[682px] max-w-[380px] max-h-[85vh] overflow-y-auto my-scrollbar border-none rounded-[24px] p-0 bg-transparent shadow-2xl">
        ...
        <AnimatePresence mode="wait">
          {showSuccess ? (
            ...
            >
              <div className="absolute inset-0 opacity-50 pointer-events-none" style={{ backgroundImage: 'url(/profile/check2.jpeg)', backgroundSize: 'auto 100%', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }} />
